...
// ── Alberta Class 7 — Road Signs (30 questions, reusing Ontario sign images) ─
const ALBERTA_SIGNS_QUESTIONS = [
  { id:1,  image:'/signs/ontario/stop.png',              question:'What does this sign mean?', choices:['Yield to cross traffic','Come to a complete stop and do not proceed until safe','Slow down and proceed with caution','No entry'], correct:1, explanation:'The red octagon STOP sign means you must come to a complete stop every time and not proceed until it is safe.' },
  { id:2,  image:'/signs/ontario/yield.png',             question:'What does this sign mean?', choices:['Stop completely','Speed up to merge','Yield the right-of-way to traffic not facing the sign and to all pedestrians','No U-turn'], correct:2, explanation:'The yield sign means slow down and give the right-of-way to traffic already in the intersection and pedestrians crossing.' },
  { id:3,  image:'/signs/ontario/do_not_enter.png',      question:'What does this sign mean?', choices:['One-way street ahead','Do not enter — traffic is moving in an oncoming direction','Road closed permanently','Construction zone ahead'], correct:1, explanation:'The Do Not Enter sign means traffic is moving toward you in that lane. Do not enter from your direction.' },
  { id:4,  image:'/signs/ontario/wrong_way.png',         question:'What does this sign mean?', choices:['Road under construction','You are going the wrong way — do not proceed','One way street ahead','Detour ahead'], correct:1, explanation:'The Wrong Way sign appears on exit ramps and one-way roads to warn you are travelling in the wrong direction.' },
  { id:5,  image:'/signs/ontario/speed_limit_50.png',    question:'What does this sign mean?', choices:['Minimum speed is 50 km/h','Recommended speed for curve','Speed limit zone ends','Maximum speed is 50 km/h'], correct:3, explanation:'Speed limit signs show the maximum speed permitted when conditions are ideal. In Alberta, 50 km/h is the default in urban areas.' },
  { id:6,  image:'/signs/ontario/speed_limit_100.png',   question:'What does this sign mean?', choices:['Minimum speed is 100 km/h','Maximum speed is 100 km/h — the default on Alberta provincial highways outside urban areas','Recommended highway speed','Speed zone ends'], correct:1, explanation:'100 km/h is the maximum speed on provincial highways outside an urban area in Alberta unless otherwise posted.' },
  { id:7,  image:'/signs/ontario/speed_limit_80.png',    question:'What does this sign mean?', choices:['Recommended curve speed','Maximum speed is 80 km/h','Minimum speed is 80 km/h','Speed limit ends'], correct:1, explanation:'80 km/h is the maximum speed limit on a provincial highway located inside a city corporate limit, or on a roadway outside an urban area that is not a provincial highway.' },
  { id:8,  image:'/signs/ontario/railway_crossing.png',  question:'What does this sign mean?', choices:['Road bump ahead','Railway crossing ahead — watch for trains','Bridge ahead','Construction zone'], correct:1, explanation:'The round railway crossing sign warns that train tracks cross the road ahead. Always look both ways before crossing.' },
  { id:9,  image:'/signs/ontario/school_zone.png',       question:'What does this sign mean?', choices:['Hospital zone','Playground zone','School zone — watch for children','Pedestrian crosswalk ahead'], correct:2, explanation:'The school zone sign warns that children may be nearby. The speed limit is 30 km/h on school days during posted hours.' },
  { id:10, image:'/signs/ontario/pedestrian_crossing.png', question:'What does this sign mean?', choices:['Bicycle crossing ahead','School crossing','Pedestrian crosswalk — watch for people crossing','Playground area'], correct:2, explanation:'The pedestrian crosswalk sign warns that people may be crossing the road ahead. Yield to all pedestrians.' },
  { id:11, image:'/signs/ontario/no_left_turn.png',      question:'What does this sign mean?', choices:['No right turn','No U-turn','No left turn permitted','One-way street'], correct:2, explanation:'The no left turn sign means you are prohibited from turning left at that intersection.' },
  { id:12, image:'/signs/ontario/no_right_turn.png',     question:'What does this sign mean?', choices:['Proceed right only','No right turn permitted','Road closed to the right','One way street'], correct:1, explanation:'The no right turn sign means you cannot turn right at that intersection.' },
  { id:13, image:'/signs/ontario/no_u_turn.png',         question:'What does this sign mean?', choices:['No left turn','No U-turn permitted at this location','Proceed straight only','One way traffic'], correct:1, explanation:'The no U-turn sign means you cannot make a U-turn at that location.' },
  { id:14, image:'/signs/ontario/do_not_pass.png',       question:'What does this sign mean?', choices:['Pass only when safe','No passing on this road','Passing lane ahead','Slow vehicles must pass here'], correct:1, explanation:'The no passing sign means you are not allowed to pass other vehicles on this section of road.' },
  { id:15, image:'/signs/ontario/two_way_traffic.png',   question:'What does this sign mean?', choices:['Lane ends merge left','Divided highway ends','Two-way traffic ahead','Road narrows'], correct:2, explanation:'This sign warns that you are entering a section of road with two-way traffic. Stay to the right.' },
  { id:16, image:'/signs/ontario/keep_right.png',        question:'What does this sign mean?', choices:['Road closed','Keep right of the divider ahead','Lane ends merge right','No passing zone'], correct:1, explanation:'The keep right sign means you must stay to the right side of a traffic island or divider.' },
  { id:17, image:'/signs/ontario/curve_ahead.png',       question:'What does this sign mean?', choices:['Sharp right turn','Road ends','Curve ahead — reduce speed and be prepared','Detour right'], correct:2, explanation:'The curve ahead sign warns of a bend in the road. Reduce speed before entering the curve and stay centred in your lane.' },
  { id:18, image:'/signs/ontario/sharp_turn.png',        question:'What does this sign mean?', choices:['Gentle curve ahead','Winding road ahead','Very sharp turn ahead — slow down significantly','Road ends'], correct:2, explanation:'A sharp turn sign indicates a severe bend. Slow down well before the sign to maintain control.' },
  { id:19, image:'/signs/ontario/winding_road.png',      question:'What does this sign mean?', choices:['One curve ahead','Sharp turn ahead','Road has several curves ahead — drive carefully','Detour ahead'], correct:2, explanation:'A winding road sign warns that the road has a series of curves ahead. Reduce speed and drive carefully.' },
  { id:20, image:'/signs/ontario/slippery_road.png',     question:'What does this sign mean?', choices:['Road under construction','Gravel road ahead','Road may be slippery when wet — reduce speed','Bumpy road ahead'], correct:2, explanation:'The slippery road sign warns the road surface becomes dangerous when wet or icy. Slow down and increase following distance.' },
  { id:21, image:'/signs/ontario/deer_crossing.png',     question:'What does this sign mean?', choices:['Farm animals crossing','Wildlife frequently crosses this area — watch for animals','Forest area ahead','Hunting zone'], correct:1, explanation:'The wildlife crossing sign warns that deer and other animals regularly cross the road in that area. Reduce speed and stay alert.' },
  { id:22, image:'/signs/ontario/construction.png',      question:'What does this sign mean?', choices:['Hospital ahead','Workers and equipment on or near the road — slow down','Road closed permanently','Detour begins'], correct:1, explanation:'Construction signs warn of road work ahead. Fines are doubled in construction zones when workers are present.' },
  { id:23, image:'/signs/ontario/road_narrows.png',      question:'What does this sign mean?', choices:['Bridge ahead','Road construction begins','The road ahead becomes narrower — stay centred','Lane ends merge left'], correct:2, explanation:'Road narrows signs warn that the pavement width decreases ahead. Slow down and stay alert.' },
  { id:24, image:'/signs/ontario/divided_highway.png',   question:'What does this sign mean?', choices:['Two-way traffic begins','Divided highway ends — two-way traffic ahead','Highway entrance','Median ends'], correct:1, explanation:'This sign warns that the divided highway is ending and you are entering a two-way road. Keep to the right.' },
  { id:25, image:'/signs/ontario/hill_ahead.png',        question:'What does this sign mean?', choices:['Speed bump ahead','Steep hill ahead — check brakes and control speed','Road ends at water','Rough road ahead'], correct:1, explanation:'The steep hill sign warns of a significant downgrade. Reduce speed and use a lower gear to prevent brake overheating.' },
  { id:26, image:'/signs/ontario/merge_right.png',       question:'What does this sign mean?', choices:['Keep left','Road narrows — merge with traffic on the right','Lane closed ahead','Passing lane ends'], correct:1, explanation:'The merge sign means your lane is ending and you must safely merge into traffic in the indicated direction.' },
  { id:27, image:'/signs/ontario/right_lane_ends.png',   question:'What does this sign mean?', choices:['Keep right','Right lane ends ahead — merge left safely','Road narrows on right','Exit ramp ahead'], correct:1, explanation:'This sign warns that the right lane is ending. Drivers in the right lane must safely merge left.' },
  { id:28, image:'/signs/ontario/bicycle_crossing.png',  question:'What does this sign mean?', choices:['Bicycle lane begins','Cyclists must stop here','Bicycles crossing the road ahead — watch for cyclists','Bicycle route ends'], correct:2, explanation:'This warning sign tells drivers that cyclists may be crossing the road ahead. Slow down and watch carefully.' },
  { id:29, image:'/signs/ontario/stop_ahead.png',        question:'What does this sign mean?', choices:['Yield sign ahead','Traffic lights ahead','Slow down — a stop sign is ahead','Road closed ahead'], correct:2, explanation:'This warning sign tells you a stop sign is coming up. Begin slowing down now and be prepared to stop completely.' },
  { id:30, image:'/signs/ontario/no_parking.png',        question:'What does this sign mean?', choices:['No stopping anytime','Parking prohibited in this area','No standing zone','Tow away zone'], correct:1, explanation:'The no parking sign means you cannot park your vehicle in that location at the times indicated.' },
];
...
const M1_QUESTIONS = [
  ...
  // ── Official Ontario M1 Questions (from official test) ────
  { id:61, question:'Class M1 licensed motorcyclists driving at night should do the following to prevent accidents:', choices:['Maintain considerable distance from other vehicles','Wear reflective clothing','Reduce the speed','Class M1 licence holders are not allowed to drive at night'], correct:3, explanation:'Class M1 licence holders are not allowed to drive at night due to their insufficient experience.' },
  { id:62, question:'In which of the following situations will the motorcycle rider need to shift his/her weight to the rear end?', choices:['When the motorcycle loses its balance','When the front tire blows','When s/he takes a turn','When the rear tire blows'], correct:1, explanation:'If a front tire blows, the motorcyclist must try to steer straight and shift his/her weight to the rear to control the vehicle.' },
  { id:63, question:'If a motorcycle rider wishes to stop his/her vehicle, while stopping, s/he must watch for traffic:', choices:['in the right lane','in front of the motorcycle','behind the motorcycle','in the left lane'], correct:2, explanation:'When a rider wants to stop his/her motorcycle, s/he must watch the traffic behind before taking the next steps.' },
  { id:64, question:'A large seat and separate footrests are required on the motorcycle for:', choices:['an animal','a passenger','a carrier or a saddlebag','balancing the vehicle'], correct:1, explanation:'The motorcycle must be equipped with a larger seat and separate footrests for a passenger.' },
  { id:65, question:'When a motorcycle rider wants to turn while moving faster than 25 km/h, s/he must use the:', choices:['brakes blocking method','gear changing method','push steering method','clutch pushing method'], correct:2, explanation:'When travelling at speeds greater than 25 km/h, the rider must push on the handgrip in the direction of the turn — this is the push steering (countersteering) method.' },
  { id:66, question:'Which of the following three documents are required for motorcycle riders in Ontario?', choices:['Insurance liability card, valid driver\'s licence, and vehicle ownership document','Vehicle ownership document, passport, and insurance liability card','Valid driver\'s licence, birth certificate, and passport','Birth certificate, marriage certificate, and valid driver\'s licence'], correct:0, explanation:'Insurance liability card, valid driver\'s licence, and vehicle ownership documents are required for all drivers in Ontario.' },
  { id:67, question:'How much stopping power is provided by the rear brake?', choices:['No stopping power','Three quarters of total stopping power','Half of total stopping power','One quarter of total stopping power'], correct:3, explanation:'Only one quarter of the total stopping power is provided by the rear brake. The front brake provides approximately three quarters.' },
  { id:68, question:'Which of the following will affect motorcycle riders more than four-wheel vehicle drivers?', choices:['Visibility of oncoming vehicles','Speed limit on highways','Roads and weather conditions','Blood alcohol content'], correct:2, explanation:'Motorcycle riders are adversely affected by road and weather changes as they are not protected like four-wheel vehicle drivers are.' },
  { id:69, question:'The motorcycle rider must use the following for correct stopping:', choices:['Both brakes simultaneously','Only the rear brake','Front brake first and rear brake next','Only the front brake'], correct:0, explanation:'Always use both brakes simultaneously to decrease the stopping distance.' },
  { id:70, question:'Perfect balance can be maintained by motorcycle riders by holding the knees firmly against the gas tank while:', choices:['passing a car','increasing speed','crossing an intersection','making turns'], correct:3, explanation:'In order to maintain balance, every motorcycle rider must hold his/her knees firmly against the gas tank while making turns.' },
  { id:71, question:'Motorcycle riders must maintain the following distance from other vehicles:', choices:['5-seconds\' distance','15-seconds\' distance','10-seconds\' distance','2-3-seconds\' distance'], correct:3, explanation:'Motorcycle riders must maintain at least a 2-to-3-seconds\' safe following distance from other vehicles.' },
  { id:72, question:'Which is a safer gear to use while going down a hill?', choices:['Any gear','Higher gear','Lower gear','The highest gear'], correct:2, explanation:'Using a lower gear while going down a hill acts as an engine brake, helping control speed without overheating the brakes.' },
  { id:73, question:'The minimum age limit for applicants of a motorcycle driving licence in Ontario is:', choices:['11 years','14 years','10 years','16 years'], correct:3, explanation:'The minimum age requirement for the M1 learner\'s licence in Ontario is 16 years.' },
  { id:74, question:'To protect the face and eyes from flying material, the motorcyclist should wear:', choices:['a mask','a cap','a face shield','eyeglasses'], correct:2, explanation:'Face protective shields protect the motorcyclist\'s face and eyes from flying objects.' },
  { id:75, question:'High speed wobble for a motorcycle can be prevented:', choices:['by slowly closing the throttle without applying brakes','by suddenly applying brakes and balancing the vehicle','by shifting the weight of the body to one side','by further increasing the speed of the vehicle'], correct:0, explanation:'High speed wobble can be prevented by slowly closing the throttle and reducing the speed without applying the brakes.' },
  { id:76, question:'If you are a fully licensed driver 21 years of age and over and you register a BAC in this range, you will receive an immediate seven-day licence suspension for a first offence:', choices:['from .08 to .09','from .03 to .04','from .01 to .03','from .05 to .08'], correct:3, explanation:'If you register a BAC from .05 to .08 (known as the "warn range"), you will receive an immediate driver\'s licence suspension. For a first occurrence, you will be suspended for seven days.' },
  { id:77, question:'To keep a motorcycle in good working condition, what formula must be followed by the driver every day?', choices:['5-point check-up formula','10-point check-up formula','12-point check-up formula','15-point check-up formula'], correct:1, explanation:'Before starting the motorcycle, every motorcycle rider must perform a daily check-up by following a 10-point formula.' },
  { id:78, question:'When a motorcycle rider wishes to enter a highway, s/he must:', choices:['take a special route for motorcycles','enter with the lowest possible speed','merge into the traffic directly','enter into the access path and then the merging area'], correct:3, explanation:'Motorcycle riders must enter into the access path and then into the acceleration zone and slowly merge into highway traffic.' },
  { id:79, question:'The area slightly to the left or the right of the centre of the lane is called the:', choices:['tire travel','vehicle track','tire track','bike track'], correct:2, explanation:'This area is called the tire track, because all tires would travel in this area. It is often cleaner and provides better traction than the centre.' },
  // ── Official Ontario M1 Questions — Batch 3 (Q32–Q40 from practice test) ────
  { id:80, question:'When a motorist reaches a through intersection where s/he may not need to stop, s/he must', choices:['yield to pedestrians and vehicles or come to a complete stop if necessary','pass with maximum speed to avoid collisions','stop in front of four-wheeled vehicles','stop between two vehicles'], correct:0, explanation:'Whenever a motorist reaches a through intersection, s/he must yield to pedestrians and other vehicles as per the right-of-way rules.' },
  { id:81, question:'The motorcyclist should avoid driving in which part of the lane when it is raining?', choices:['Left part of the lane','Centre of the lane','Right part of the lane','None of the above'], correct:1, explanation:'The centre part of the lane is more slippery due to oil and grease buildup. Motorcyclists should avoid that particular area in wet conditions.' },
  { id:82, question:'While making a turn, the passenger on a motorcycle must', choices:['bend backward','maintain straight posture','lean in the opposite direction of the turn','lean in the direction of the turn'], correct:3, explanation:'The driver as well as the passenger must lean in the direction of the turn.' },
  { id:83, question:'The motorcycle rider must check his/her mirrors every', choices:['9-10 seconds','4-5 seconds','5-7 seconds','1-2 seconds'], correct:2, explanation:'Motorcycle riders must check their mirrors every 5-7 seconds to watch the traffic behind them.' },
  { id:84, question:'What should the driver do when the motorcycle chain locks the rear wheel?', choices:['Maintain control and pull over immediately','Hit the brakes hard','Turn off and turn on the engine','Apply brakes to stop the vehicle immediately'], correct:0, explanation:'When the chain locks the rear wheel, maintain control and pull over immediately.' },
  { id:85, question:'When entering a curve, you should', choices:['reduce your speed before the curve','look as far around it as possible','turn your head, not your shoulders, in the direction of the curve','do all of the above'], correct:3, explanation:'As you enter a curve, reduce speed beforehand, look as far around it as possible, and turn your head in the direction of the curve to stay in a smooth line.' },
  { id:86, question:'Which of the following actions can save a motorcycle rider\'s life when s/he wants to change lanes, position within a lane, or before turning off the roadway?', choices:['Slowing down quickly','A quick shoulder check','A sudden gear change','A quick movement toward the other lane'], correct:1, explanation:'The driver should do a quick shoulder check before changing lane position, position within a lane, or before turning off the roadway.' },
  { id:87, question:'The taillights of other vehicles are useful to motorists', choices:['to avoid blind spots of the vehicle','to see the bumps or rough pavement','to estimate the distance of the vehicle','to judge the speed of the vehicle'], correct:1, explanation:'The vehicle\'s taillights can alert the motorist of any rough conditions of the road.' },
  { id:88, question:'When a motorcycle bounces, the motorcycle rider can be protected from immediate danger by', choices:['bending the body into the proper direction','holding handgrips firmly','removing his/her feet from the footpegs and balancing them','dragging the feet along the ground'], correct:1, explanation:'The driver must hold the handgrips firmly so as to not lose grip if the motorcycle bounces.' },
  // ── Official Ontario M1 Questions — Batch 4 (Q22–Q31 from practice test) ────
  { id:89, question:'Incorrect use of gears can result in accidents when', choices:['riding in heavy traffic','changing gears on plain roads','downshifting, turning, or starting on hills','riding with a passenger on two-way roads'], correct:2, explanation:'There is more to shifting gears than simply getting the motorcycle to accelerate smoothly. Accidents can occur if the gears are used incorrectly, when downshifting, turning, or starting on hills.' },
  { id:90, question:'Due to excessive sand and gravel, the motorcycle rider must not drive', choices:['along the middle of the lane','along the side of the pavement','near the right edge of the left lane','near the left edge of the right lane'], correct:1, explanation:'Sand and gravel usually collect along the side of the pavement.' },
  { id:91, question:'Motorcycle riders must not ride their vehicles', choices:['in the right lane','behind a passenger vehicle','between two lanes','in the left lane'], correct:2, explanation:'The motorcycle rider should never ride between two lanes, as each lane is designed for only one vehicle.' },
  { id:92, question:'Motorcycle riders must give the right-of-way to', choices:['pedestrians','heavy goods trucks','four-wheelers','other motorcycles'], correct:0, explanation:'Motorcycle riders must stop for pedestrians at crosswalks or intersections.' },
  { id:93, question:'What is the purpose of using a helmet while riding a motorcycle?', choices:['To function as a balance for the motorcycle','To protect the motorcyclist from head injuries in case of a crash','To protect the motorcyclist from rain and snow','To protect the motorcyclist from sun rays'], correct:1, explanation:'As per Ontario law, every motorcycle rider and passenger must wear a proper helmet while moving on a motorcycle. It provides protection from head injuries during a collision.' },
  { id:94, question:'Which of the following is most useful to the motorcycle rider to help him/her maintain balance?', choices:['Regular body movements while riding','Correct use of lower gears','Keeping the feet steady on the footpegs','Wearing a helmet'], correct:2, explanation:'Motorcycle riders must keep their feet firmly on the footpegs. This will help them maintain balance.' },
  { id:95, question:'The three principles used when braking hard in a turn are', choices:['straighten, square, squeeze','square, push, lean','turn, slow, squeeze','control, straighten, move'], correct:0, explanation:'When braking hard in a turn, the driver must follow the principles of "straighten, square, squeeze" and practice them.' },
  { id:96, question:'When a motorcycle rider approaches a railway crossing and the signal lights are flashing, what should s/he do?', choices:['Stop the motorcycle 15 metres away from the nearest track','Stop 5 metres away from the nearest track','Cross the rail track with a speed of 80 km/h','Stop 12 metres from the farthest track'], correct:1, explanation:'Motorcyclists must maintain a 5-metre distance from the nearest railway track at railway crossings.' },
  { id:97, question:'For safe driving on the road, a driver must do the following', choices:['Check the surroundings and scan the road in all directions','Apply brakes often to prevent any collisions','Turn the headlights on to improve vision','Change lanes frequently to avoid any accidents with fast-moving vehicles'], correct:0, explanation:'The driver must watch the surrounding areas and scan the road in all directions to prevent accidents.' },
  { id:98, question:'To make a safe turn, the motorcyclist must', choices:['lean the bike against the direction of the turn','lean the bike in the direction of the turn','take sharp turn','use a higher gear'], correct:1, explanation:'To turn a motorcycle safely, the rider must lean the bike in the direction of the turn.' },
];
...
const ALBERTA_QUESTIONS = [
  ...
  { id:2, question:'What is the maximum default speed limit on a provincial highway outside an urban area in Alberta?', choices:['90 km/h','100 km/h','110 km/h','120 km/h'], correct:1, explanation:'Unless otherwise posted, the maximum speed limit on a provincial highway outside an urban area in Alberta is 100 km/h.' },  { id:3,  question:'What is the blood alcohol concentration (BAC) limit for a fully licensed driver in Alberta?', choices:['0.05%','0.08%','0.10%','0.00%'], correct:1, explanation:'The legal limit in Alberta is 0.08%. However, at 0.05% you face immediate licence suspension under the warn range.' },
  ...
  { id:8, question:'In Alberta, when must a Learner (Class 7) driver be accompanied?', choices:['Only on highways','At all times by a fully-licensed non-GDL driver who is 18 years of age or older, seated next to you','Only at night','Only when driving outside the city'], correct:1, explanation:'A Class 7 learner must always be accompanied by a fully-licensed (non-GDL) driver who is 18 years of age or older and is seated in the front passenger seat.' },  { id:9, question:'What is the speed limit in a school zone in Alberta?', choices:['20 km/h','30 km/h','40 km/h','50 km/h'], correct:1, explanation:'School zones in Alberta have a speed limit of 30 km/h on school days during: 8:00–9:30 a.m., 11:30 a.m.–1:30 p.m., and 3:00–4:30 p.m.' },  { id:10, question:'What is the speed limit in a playground zone in Alberta?', choices:['20 km/h','30 km/h','40 km/h','50 km/h'], correct:1, explanation:'Playground zones in Alberta have a speed limit of 30 km/h when the zone is in effect (8:30 a.m. to one hour after sunset, every day).' },  { id:11, question:'When must you signal before turning in Alberta?', choices:['Only at intersections with traffic lights','At least 30 metres before turning or changing lanes','Only on highways','Only when other vehicles are present'], correct:1, explanation:'Alberta law requires signalling at least 30 metres before turning or changing lanes.' },
  ...
  { id:19, question:'What does a flashing green light mean in Alberta?', choices:['Proceed with caution','You may go straight, turn left, or turn right without stopping — opposing traffic faces red','The light is about to change to yellow','Yield to pedestrians only'], correct:1, explanation:'A flashing green light in Alberta means you may go through, turn left, or turn right without stopping. Opposing traffic faces a red light, but you must still yield to pedestrians in the intersection.' },  { id:20, question:'In Alberta, using a handheld cell phone while driving results in:', choices:['A verbal warning only','A fine and 3 demerit points','Only a fine — no demerit points','Just a fine for first offence only'], correct:1, explanation:'Distracted driving in Alberta carries a fine and 3 demerit points. Repeat offences within 2 years result in higher fines.' },
  ...
  { id:31, question:'What is the minimum age to apply for a Class 7 Learner\'s licence in Alberta?', choices:['14 years old','16 years old','17 years old','18 years old'], correct:0, explanation:'You must be at least 14 years old to apply for a Class 7 learner\'s licence in Alberta. Parental consent is required if under 18.' },  { id:32, question:'In Alberta, where must you yield to pedestrians?', choices:['Only at marked crosswalks with traffic lights','At all crosswalks — marked or unmarked — and intersection corners','Only when a pedestrian steps into the road','Only in school zones'], correct:1, explanation:'In Alberta you must yield to pedestrians at all crosswalks whether marked or unmarked. This includes any intersection corner.' },
  ...
  { id:41, question:'What are the school zone hours in Alberta when the 30 km/h speed limit applies?', choices:['All day on school days','8:00–9:30 a.m., 11:30 a.m.–1:30 p.m., and 3:00–4:30 p.m. on school days','8:00 a.m. to 5:00 p.m. every day','7:00 a.m. to 6:00 p.m. on school days'], correct:1, explanation:'School zone hours in Alberta are 8:00–9:30 a.m., 11:30 a.m.–1:30 p.m., and 3:00–4:30 p.m. on school days only.' },
  { id:42, question:'When are playground zone restrictions in effect in Alberta?', choices:['Only on school days from 8 a.m. to 5 p.m.','Every day from 8:30 a.m. to one hour after sunset','Only on weekends during daylight hours','From sunrise to sunset on school days'], correct:1, explanation:'Playground zone restrictions apply every day from 8:30 a.m. to one hour after sunset — not just on school days.' },
  { id:43, question:'What speed must you reduce to when passing a stopped emergency vehicle with flashing lights on an Alberta highway?', choices:['40 km/h or posted speed whichever is lower','50 km/h','60 km/h or the posted speed whichever is lower','80 km/h'], correct:2, explanation:'Motorists must reduce speed to 60 km/h or the posted speed limit, whichever is lower, when passing emergency vehicles or tow trucks stopped with flashing lights.' },
  { id:44, question:'At a GDL stage, how many demerit points result in a licence suspension?', choices:['8 or more demerit points','10 or more demerit points','12 or more demerit points','15 or more demerit points'], correct:0, explanation:'GDL drivers (Class 7 learner or Class 5-GDL probationary) will be suspended if they accumulate 8 or more demerit points.' },
  { id:45, question:'How far from an intersection must you stop if there is no stop line or crosswalk in Alberta?', choices:['1 metre','2 metres','3 metres','5 metres'], correct:2, explanation:'If there is no stop line or marked crosswalk, you must stop within three metres (10 feet) of the intersecting roadway.' },
  { id:46, question:'When is a U-turn prohibited on a rural (outside urban area) Alberta road?', choices:['Never — U-turns are always legal outside cities','On a curve or within 150 metres of a hill crest where you cannot be seen','Only when a sign prohibits it','Only on provincial highways'], correct:1, explanation:'Outside urban areas, U-turns are not permitted on a curve or on an approach to or near the crest of a hill where a driver within 150 metres approaching from either direction cannot see you.' },
  { id:47, question:'What must you do when your vehicle breaks down on an Alberta highway?', choices:['Stay in the travel lane and call for help','Move to a safe location, turn on hazard lights, raise your hood, and use reflective triangles','Stop immediately where you are','Call police before moving your vehicle'], correct:1, explanation:'Move to a safe location off the travel lane if possible. Turn on hazard lights (four-way flashers), raise your hood, and use reflective triangles to warn other drivers.' },
  { id:48, question:'When turning left at an intersection, where should your front wheels be pointed if you are stopped waiting for oncoming traffic?', choices:['Turned left ready to complete the turn','Straight ahead — do not turn wheels until you are ready to move','Slightly to the right','It does not matter'], correct:1, explanation:'Keep your front wheels pointed straight ahead when stopped in an intersection waiting to turn left. If hit from behind, this prevents your vehicle from being pushed into oncoming traffic.' },
];

// ── Alberta Class 7 Arabic — General Rules (48 questions) ────
const ALBERTA_ARABIC_QUESTIONS = [
  { id:1,  question:'ما هو الحد الافتراضي للسرعة في المناطق الحضرية في ألبرتا ما لم تُنشر لافتة أخرى؟', choices:['40 كم/س','50 كم/س','60 كم/س','70 كم/س'], correct:1, explanation:'الحد الأقصى الافتراضي للسرعة في المناطق الحضرية في ألبرتا هو 50 كم/س ما لم تشر لافتة إلى خلاف ذلك.' },
  { id:2,  question:'ما هو الحد الأقصى الافتراضي للسرعة على الطريق الإقليمي خارج المنطقة الحضرية في ألبرتا؟', choices:['90 كم/س','100 كم/س','110 كم/س','120 كم/س'], correct:1, explanation:'ما لم تُنشر لافتة أخرى، الحد الأقصى للسرعة على الطريق الإقليمي خارج المنطقة الحضرية في ألبرتا هو 100 كم/س.' },
  { id:3,  question:'ما هو الحد القانوني لتركيز الكحول في الدم للسائق الحاصل على رخصة كاملة في ألبرتا؟', choices:['0.05%','0.08%','0.10%','0.00%'], correct:1, explanation:'الحد القانوني في ألبرتا هو 0.08%. غير أن نسبة 0.05% تؤدي إلى تعليق فوري للرخصة تحت ما يُعرف بـ"نطاق التحذير".' },
  { id:4,  question:'ما هو مستوى الكحول في الدم الذي يؤدي إلى تعليق فوري للرخصة على جانب الطريق في ألبرتا؟', choices:['0.02%','0.04%','0.05%','0.08%'], correct:2, explanation:'في ألبرتا، يؤدي مستوى 0.05% أو أكثر إلى تعليق فوري للرخصة على جانب الطريق حتى لو كان الحد الجنائي هو 0.08%.' },
  { id:5,  question:'ما هو برنامج رخصة القيادة المتدرجة (GDL) في ألبرتا؟', choices:['نظام نقاط فقط','نظام تعلم من مرحلتين (مرحلة المتعلم ومرحلة التجربة) قبل الحصول على الرخصة الكاملة','برنامج القيادة التجارية','دورة تدريبية متقدمة للقيادة'], correct:1, explanation:'يتضمن برنامج GDL في ألبرتا مرحلتين: مرحلة المتعلم (سنة على الأقل) ومرحلة التجربة (سنتان على الأقل)، لكل منهما قيود خاصة.' },
  { id:6,  question:'خلال مرحلة المتعلم في ألبرتا، ما هو الحد المسموح به للكحول في الدم؟', choices:['0.05%','0.08%','0.00% — صفر تسامح','0.03%'], correct:2, explanation:'يجب أن يكون مستوى الكحول في دم سائقي مرحلتَي المتعلم والتجربة صفراً تماماً. أي كمية منه تُعدّ مخالفة.' },
  { id:7,  question:'كم المدة التي يجب أن تحمل فيها رخصة المتعلم في ألبرتا قبل الانتقال إلى مرحلة التجربة؟', choices:['6 أشهر','12 شهراً','18 شهراً','24 شهراً'], correct:1, explanation:'يجب أن تحمل رخصة المتعلم لمدة 12 شهراً على الأقل قبل اجتياز اختبار القيادة للانتقال إلى مرحلة التجربة.' },
  { id:8,  question:'متى يجب أن يكون سائق المتعلم (الصنف 7) مصحوباً في ألبرتا؟', choices:['على الطرق السريعة فقط','في جميع الأوقات بواسطة سائق حاصل على رخصة كاملة غير GDL يبلغ 18 عاماً أو أكثر جالساً بجانبه','في الليل فقط','خارج المدينة فقط'], correct:1, explanation:'يجب أن يكون سائق الصنف 7 مصحوباً دائماً بسائق حاصل على رخصة كاملة (غير GDL) يبلغ 18 عاماً أو أكثر جالساً في المقعد الأمامي.' },
  { id:9,  question:'ما هو حد السرعة في المنطقة المدرسية في ألبرتا؟', choices:['20 كم/س','30 كم/س','40 كم/س','50 كم/س'], correct:1, explanation:'حد السرعة في المناطق المدرسية في ألبرتا هو 30 كم/س خلال أيام الدراسة في الأوقات: 8:00–9:30 ص، 11:30 ص–1:30 م، و3:00–4:30 م.' },
  { id:10, question:'ما هو حد السرعة في منطقة الملاعب في ألبرتا؟', choices:['20 كم/س','30 كم/س','40 كم/س','50 كم/س'], correct:1, explanation:'حد السرعة في مناطق الملاعب في ألبرتا هو 30 كم/س عندما تكون المنطقة سارية — كل يوم من الساعة 8:30 صباحاً حتى ساعة بعد غروب الشمس.' },
  { id:11, question:'متى يجب الإشارة قبل الانعطاف في ألبرتا؟', choices:['عند التقاطعات المضاءة فقط','قبل 30 متراً على الأقل من الانعطاف أو تغيير المسار','على الطرق السريعة فقط','عند وجود مركبات أخرى فقط'], correct:1, explanation:'يوجب قانون ألبرتا الإشارة قبل 30 متراً على الأقل من الانعطاف أو تغيير المسار.' },
  { id:12, question:'عند الاقتراب من حافلة مدرسية تضيء مصابيحها الحمراء على طريق غير مقسّم في ألبرتا، يجب:', choices:['إبطاء السرعة إلى 20 كم/س والمتابعة','التوقف من كلا الاتجاهين حتى تتوقف الأضواء','التوقف فقط إذا كنت خلف الحافلة','التوقف خلال أوقات المدرسة فقط'], correct:1, explanation:'على الطرق غير المقسّمة، يجب على جميع المركبات من كلا الاتجاهين التوقف عندما تضيء الحافلة المدرسية مصابيحها الحمراء. انتظر حتى تتوقف.' },
  { id:13, question:'ما هو قانون "تغيير المسار" (Move Over) في ألبرتا؟', choices:['قاعدة تغيير المسار على الطرق السريعة','يجب إبطاء السرعة والانتقال إلى مسار آخر عند تجاوز مركبات الطوارئ وشاحنات القطر ومركبات صيانة الطرق المتوقفة بأضواء وامضة','قاعدة إعطاء الأولوية للمركبات المندمجة','يجب على المركبات البقاء في المسار الأيمن'], correct:1, explanation:'يلزم قانون "تغيير المسار" في ألبرتا السائقين بإبطاء السرعة والانتقال إلى مسار آخر عند المرور بأي مركبة متوقفة بأضواء وامضة على جانب الطريق.' },
  { id:14, question:'في ألبرتا، ما هي المسافة الدنيا للوقوف من صنبور الحريق؟', choices:['متر واحد','3 أمتار','5 أمتار','6 أمتار'], correct:2, explanation:'يُحظر الوقوف على بُعد أقل من 5 أمتار من صنبور الحريق في ألبرتا.' },
  { id:15, question:'متى يمكنك الانعطاف يميناً عند الضوء الأحمر في ألبرتا؟', choices:['لا يجوز أبداً','بعد توقف تام مع إعطاء الأولوية للمشاة والمركبات ما لم تُنشر لافتة تمنع ذلك','في أي وقت دون توقف','بين الساعة 10 مساءً و6 صباحاً فقط'], correct:1, explanation:'يمكنك الانعطاف يميناً عند الضوء الأحمر بعد توقف تام وإعطاء الأولوية لجميع المركبات والمشاة، ما لم تكن هناك لافتة تمنع ذلك.' },
  { id:16, question:'ما هي المسافة الزمنية الدنيا الموصى بها للمتابعة في ألبرتا؟', choices:['ثانية واحدة','ثانيتان','3 ثوانٍ','4 ثوانٍ'], correct:1, explanation:'توصي ألبرتا بمسافة متابعة لا تقل عن ثانيتين. زِدها إلى 4 ثوانٍ أو أكثر في الطقس السيئ.' },
  { id:17, question:'في ألبرتا، عند الاقتراب من تقاطع غير مُتحكَّم به، من له الأولوية؟', choices:['السائق على الطريق الأكبر','السائق الذي يصل أولاً؛ وإذا وصلا في نفس الوقت يُعطى الأولوية للمركبة على اليمين','السائق المتجه مباشرة','السائق المنعطف يساراً'], correct:1, explanation:'في التقاطعات غير المُتحكَّم بها، من يصل أولاً له الأولوية. إذا وصلا في نفس الوقت، أعطِ الأولوية للمركبة على يمينك.' },
  { id:18, question:'ماذا يجب أن تفعل قبل الدخول إلى دوّار (roundabout) في ألبرتا؟', choices:['لديك الأولوية عند الدخول','أعطِ الأولوية لجميع المركبات الموجودة في الدوّار','توقف تماماً قبل الدخول','أضئ مصابيحك للإشارة بالدخول'], correct:1, explanation:'أعطِ الأولوية دائماً للمركبات المتحركة داخل الدوّار. ادخل فقط عندما تجد فجوة آمنة.' },
  { id:19, question:'ماذا يعني الضوء الأخضر الوامض في ألبرتا؟', choices:['تابع بحذر فقط','يمكنك السير مباشرة أو الانعطاف يساراً أو يميناً دون توقف — المرور المقابل أمامه ضوء أحمر','الضوء على وشك التحوّل إلى أصفر','أعطِ الأولوية للمشاة فقط'], correct:1, explanation:'الضوء الأخضر الوامض في ألبرتا يعني أنه يمكنك المرور مباشرة أو الانعطاف يساراً أو يميناً دون توقف. المرور المقابل أمامه ضوء أحمر، لكن يجب إعطاء الأولوية للمشاة في التقاطع.' },
  { id:20, question:'في ألبرتا، استخدام الهاتف المحمول باليد أثناء القيادة يؤدي إلى:', choices:['تحذير شفهي فقط','غرامة مالية وثلاث نقاط في سجل المخالفات','غرامة مالية فقط — لا نقاط','غرامة فقط عند المخالفة الأولى'], correct:1, explanation:'القيادة المشتتة في ألبرتا تؤدي إلى غرامة مالية وثلاث نقاط مخالفة. تتضاعف الغرامة عند التكرار خلال سنتين.' },
  { id:21, question:'ما هو نظام نقاط المخالفات في ألبرتا؟', choices:['نقاط تُضاف مقابل القيادة الجيدة','نقاط تُضاف للمخالفات المرورية — تراكمها يؤدي إلى تعليق الرخصة','نقاط تُخصم من رصيد ابتدائي','تسري على السائقين الجدد فقط'], correct:1, explanation:'يُضيف نظام المخالفات في ألبرتا نقاطاً لكل مخالفة. تعليق الرخصة يحدث عند 15 نقطة للسائق الكامل، و8 نقاط لسائق GDL.' },
  { id:22, question:'كم عدد نقاط المخالفة لتجاوز الضوء الأحمر في ألبرتا؟', choices:['نقطتان','3 نقاط','4 نقاط','6 نقاط'], correct:1, explanation:'تجاوز الضوء الأحمر في ألبرتا يؤدي إلى 3 نقاط مخالفة وغرامة مالية.' },
  { id:23, question:'متى يجب تشغيل المصابيح الأمامية في ألبرتا؟', choices:['في الليل فقط','من 30 دقيقة بعد الغروب إلى 30 دقيقة قبل الشروق وعند ضعف الرؤية','في المطر والثلج فقط','على الطرق السريعة فقط'], correct:1, explanation:'تشترط ألبرتا تشغيل المصابيح من 30 دقيقة بعد غروب الشمس إلى 30 دقيقة قبل شروقها وعند ضعف الرؤية.' },
  { id:24, question:'في ألبرتا، متى يُسمح بالتجاوز من اليمين؟', choices:['لا يُسمح أبداً','عندما تنعطف المركبة الأمامية يساراً وهناك مسار واضح على اليمين','في أي وقت على الطريق متعدد المسارات','على الطرق السريعة فقط'], correct:1, explanation:'يُسمح بالتجاوز من اليمين فقط عندما تنعطف المركبة الأمامية يساراً وهناك مساحة كافية. لا تقُد خارج الرصيف الممهّد.' },
  { id:25, question:'ماذا يجب أن تفعل عندما تقترب مركبة طوارئ بأضواء وصفارة من خلفك في ألبرتا؟', choices:['أسرع للإفساح','انتقل إلى الجانب الأيمن وتوقف حتى تمر','استمر بنفس السرعة','انتقل إلى الجانب الأيسر'], correct:1, explanation:'انتقل إلى الجانب الأيمن من الطريق وتوقف. انتظر حتى تمر مركبة الطوارئ بالكامل قبل المتابعة.' },
  { id:26, question:'في ألبرتا، ما هي عقوبة القيادة المشتتة التي تسبب الوفاة؟', choices:['غرامة 1,000 دولار وثلاث نقاط','غرامة تصل إلى 1,200 دولار وست نقاط','تهم جنائية بموجب قانون العقوبات الكندي','نفس غرامة القيادة المشتتة العادية'], correct:2, explanation:'القيادة المشتتة التي تسبب الوفاة تُعدّ جريمة جنائية بموجب قانون العقوبات. تُضاف إليها العقوبات الإقليمية.' },
  { id:27, question:'ماذا تعني الخط الأبيض الصلب الفاصل بين المسارات في ألبرتا؟', choices:['يمكن تجاوزه لتغيير المسار','لا تتجاوزه — إنه حدٌّ لا يجب تجاوزه','يبدأ مسار التجاوز','علامة مسار الدراجات'], correct:1, explanation:'الخط الأبيض الصلب يُحدد حداً للمسار لا ينبغي تجاوزه، مثل حافة الطريق أو حدود المسار المخصص.' },
  { id:28, question:'ما هو الإجراء الصحيح عند رؤية الضوء الأصفر في ألبرتا؟', choices:['أسرع لاجتياز التقاطع','توقف إذا أمكن ذلك بأمان — الضوء على وشك التحوّل إلى أحمر','تابع — الأصفر يعني الحذر فقط','أعطِ الأولوية للمشاة وتابع'], correct:1, explanation:'الضوء الأصفر يعني أن الإشارة ستتحوّل إلى حمراء. توقف بأمان إذا أمكن. لا تسرع لتجاوزه.' },
  { id:29, question:'في ألبرتا، ماذا يجب أن تفعل عند لافتة STOP (قف)؟', choices:['أبطئ وتحقق من المرور','توقف تماماً عند خط التوقف وأعطِ الأولوية لجميع المركبات ثم تابع بأمان','توقف فقط إذا كانت هناك مركبات أخرى','عاملها كلافتة إفساح خارج أوقات الذروة'], correct:1, explanation:'يجب التوقف التام عند خط التوقف (أو قبل ممر المشاة/التقاطع). أعطِ الأولوية لجميع المركبات والمشاة قبل المتابعة.' },
  { id:30, question:'عند القيادة في الضباب في ألبرتا، يجب استخدام:', choices:['المصابيح العالية لأقصى رؤية','المصابيح الخافتة — المصابيح العالية تنعكس على الضباب','أضواء الطوارئ فقط','لا إضاءة خاصة مطلوبة'], correct:1, explanation:'استخدم المصابيح الخافتة في الضباب. المصابيح العالية تنعكس على جزيئات الضباب وتقلل الرؤية بشكل كبير.' },
  { id:31, question:'ما هو الحد الأدنى للسن للتقدم بطلب رخصة المتعلم من الصنف 7 في ألبرتا؟', choices:['14 عاماً','16 عاماً','17 عاماً','18 عاماً'], correct:0, explanation:'يجب أن يكون عمرك 14 عاماً على الأقل للتقدم بطلب رخصة المتعلم من الصنف 7 في ألبرتا. يُشترط موافقة الوالدين إذا كنت دون سن 18.' },
  { id:32, question:'في ألبرتا، أين يجب إعطاء الأولوية للمشاة؟', choices:['عند ممرات المشاة المميّزة ذات الإشارات فقط','عند جميع ممرات المشاة — المميّزة وغير المميّزة — وزوايا التقاطعات','فقط عندما يخطو المشاة إلى الطريق','في المناطق المدرسية فقط'], correct:1, explanation:'في ألبرتا يجب إعطاء الأولوية للمشاة عند جميع ممرات المشاة سواء كانت مميّزة أو غير مميّزة، بما في ذلك زوايا التقاطعات.' },
  { id:33, question:'ما هو حد السرعة في الأزقة في ألبرتا؟', choices:['15 كم/س','20 كم/س','30 كم/س','40 كم/س'], correct:1, explanation:'حد السرعة في الأزقة في ألبرتا هو 20 كم/س.' },
  { id:34, question:'متى يجب زيادة مسافة المتابعة عن ثانيتين في ألبرتا؟', choices:['في الثلج فقط','في المطر والثلج والجليد والضباب والازدحام المروري وفي الليل أو عند السحب','على الطرق المحصوصة فقط','على الطرق السريعة فوق 100 كم/س فقط'], correct:1, explanation:'زِد مسافة المتابعة في أي حالة تقلل من السيطرة أو الرؤية — المطر والثلج والجليد والضباب والظلام والازدحام أو السحب.' },
  { id:35, question:'ماذا تعني الخطوط الصفراء المتقطعة في منتصف الطريق ذي الاتجاهين في ألبرتا؟', choices:['لا تجاوز في أي اتجاه','التجاوز مسموح به عند الأمان','منطقة بناء أمامك','مسار الانعطاف يساراً لاتجاهين'], correct:1, explanation:'الخطوط الصفراء المتقطعة تعني أن التجاوز مسموح به من كلا الاتجاهين عند الأمان.' },
  { id:36, question:'في ألبرتا، كم عدد نقاط المخالفة التي تؤدي إلى تعليق رخصة السائق الكامل؟', choices:['8 نقاط','10 نقاط','12 نقطة','15 نقطة'], correct:3, explanation:'يواجه السائق الكامل في ألبرتا تعليق رخصته لمدة 30 يوماً عند تراكم 15 نقطة أو أكثر.' },
  { id:37, question:'ما هو الغرض من سجل القيادة الآمنة في ألبرتا؟', choices:['يمنحك نقاطاً مقابل القيادة الجيدة تعوّض المخالفات','يتتبع المخالفات فقط — لا توجد نقاط إيجابية','يخفض معدل التأمين تلقائياً','يسمح لك بتجاوز الحد الأقصى للسرعة بمقدار 10 كم/س'], correct:1, explanation:'يتتبع نظام المخالفات في ألبرتا المخالفات فقط. لا توجد نقاط إيجابية — المخالفات تُضيف نقاطاً حتى الوصول إلى حد التعليق.' },
  { id:38, question:'عند التراجع بالسيارة في ألبرتا، يجب:', choices:['مراقبة المرآة الخلفية فقط','النظر فوق الكتف في اتجاه الحركة وفحص جميع المرايا','الإشارة والتراجع بسرعة','مراقبة المشاة فقط'], correct:1, explanation:'عند التراجع، انظر دائماً فوق كتفك في اتجاه الحركة وافحص جميع المرايا. لا تعتمد على المرايا وحدها.' },
  { id:39, question:'في ألبرتا، يجب الإبلاغ عن الحادث للشرطة عندما يتجاوز إجمالي الأضرار:', choices:['1,000 دولار','2,000 دولار','5,000 دولار','10,000 دولار'], correct:1, explanation:'في ألبرتا، يجب الإبلاغ عن الحوادث للشرطة عندما يتجاوز إجمالي الأضرار للمركبات والممتلكات 2,000 دولار.' },
  { id:40, question:'ماذا تعني الخطوط الصفراء المزدوجة الصلبة في منتصف الطريق في ألبرتا؟', choices:['التجاوز مسموح من كلا الاتجاهين','لا تجاوز من أي اتجاه — لا تتجاوز هذا الخط','تحذير منطقة بناء','يبدأ الطريق المقسوم'], correct:1, explanation:'الخطوط الصفراء المزدوجة الصلبة تعني أن التجاوز محظور من كلا الاتجاهين. لا تتجاوز هذه العلامة.' },
  { id:41, question:'ما هي أوقات المناطق المدرسية في ألبرتا التي يسري فيها حد السرعة 30 كم/س؟', choices:['طوال اليوم في أيام الدراسة','8:00–9:30 ص، 11:30 ص–1:30 م، و3:00–4:30 م في أيام الدراسة','من 8 صباحاً حتى 5 مساءً كل يوم','من 7 صباحاً حتى 6 مساءً في أيام الدراسة'], correct:1, explanation:'أوقات المناطق المدرسية في ألبرتا هي: 8:00–9:30 ص، 11:30 ص–1:30 م، و3:00–4:30 م في أيام الدراسة فقط.' },
  { id:42, question:'متى تسري قيود منطقة الملاعب في ألبرتا؟', choices:['في أيام الدراسة فقط من 8 ص حتى 5 م','كل يوم من 8:30 صباحاً حتى ساعة بعد غروب الشمس','في عطل نهاية الأسبوع فقط خلال ساعات النهار','من شروق الشمس إلى غروبها في أيام الدراسة'], correct:1, explanation:'تسري قيود منطقة الملاعب كل يوم من الساعة 8:30 صباحاً حتى ساعة بعد غروب الشمس — وليس فقط في أيام الدراسة.' },
  { id:43, question:'ما هي السرعة التي يجب تخفيضها إليها عند المرور بمركبة طوارئ متوقفة بأضواء وامضة على طريق سريع في ألبرتا؟', choices:['40 كم/س أو الحد المنشور أيهما أقل','50 كم/س','60 كم/س أو الحد المنشور أيهما أقل','80 كم/س'], correct:2, explanation:'يجب تخفيض السرعة إلى 60 كم/س أو الحد المنشور أيهما أقل عند المرور بمركبات الطوارئ أو شاحنات القطر المتوقفة بأضواء وامضة.' },
  { id:44, question:'في مرحلة GDL، كم عدد نقاط المخالفة التي تؤدي إلى تعليق الرخصة؟', choices:['8 نقاط أو أكثر','10 نقاط أو أكثر','12 نقطة أو أكثر','15 نقطة أو أكثر'], correct:0, explanation:'يواجه سائقو GDL (الصنف 7 أو الصنف 5 تجريبي) تعليق رخصتهم عند تراكم 8 نقاط مخالفة أو أكثر.' },
  { id:45, question:'كم يجب أن تكون المسافة من التقاطع إذا لم يكن هناك خط توقف أو ممر مشاة في ألبرتا؟', choices:['متر واحد','مترين','3 أمتار','5 أمتار'], correct:2, explanation:'إذا لم يكن هناك خط توقف أو ممر مشاة، يجب التوقف في غضون 3 أمتار (10 أقدام) من الطريق المتقاطع.' },
  { id:46, question:'متى يُحظر الانعطاف بالاتجاه العكسي (U-turn) على الطريق الريفي خارج المناطق الحضرية في ألبرتا؟', choices:['لا يُحظر أبداً — مسموح دائماً خارج المدن','عند المنحنيات أو في غضون 150 متراً من قمة تل لا يمكن رؤيتك منها','عند وجود لافتة تمنع ذلك فقط','على الطرق الإقليمية فقط'], correct:1, explanation:'خارج المناطق الحضرية، يُحظر الانعطاف بالاتجاه العكسي عند المنحنيات أو في غضون 150 متراً من قمة تل حيث لا يمكن لسائق قادم رؤيتك.' },
  { id:47, question:'ماذا يجب أن تفعل عند تعطل سيارتك على الطريق السريع في ألبرتا؟', choices:['ابقَ في مسار السير واتصل للمساعدة','انتقل إلى مكان آمن وشغّل أضواء الطوارئ وارفع الغطاء واستخدم مثلثات التحذير','توقف فوراً في مكانك','اتصل بالشرطة قبل تحريك السيارة'], correct:1, explanation:'انتقل إلى مكان آمن بعيداً عن مسار السير إن أمكن. شغّل أضواء الطوارئ وارفع غطاء المحرك واستخدم مثلثات التحذير لتنبيه السائقين الآخرين.' },
  { id:48, question:'عند الانعطاف يساراً في تقاطع وأنت متوقف تنتظر المرور القادم، أين يجب أن تكون عجلاتك الأمامية موجّهة؟', choices:['منعطفة يساراً جاهزة لإكمال الانعطاف','مستقيمة للأمام — لا تدِر العجلات حتى تكون مستعداً للتحرك','منعطفة قليلاً إلى اليمين','لا يهم'], correct:1, explanation:'ابقِ عجلاتك الأمامية مستقيمة للأمام أثناء انتظارك لإكمال الانعطاف يساراً. إذا اصطدمت من الخلف، لن تنزلق مركبتك نحو المرور القادم.' },
];

// ── Alberta Class 7 Arabic — Road Signs (30 questions) ────────
const ALBERTA_ARABIC_SIGNS_QUESTIONS = [
  { id:1,  image:'/signs/ontario/stop.png',              question:'ماذا تعني هذه اللافتة؟', choices:['أعطِ الأولوية للمرور المتقاطع','توقف توقفاً تاماً ولا تتابع حتى يكون الطريق آمناً','أبطئ وتابع بحذر','لا دخول'], correct:1, explanation:'لافتة STOP المثمنة الحمراء تعني التوقف التام في كل مرة وعدم المتابعة حتى يكون الطريق آمناً.' },
  { id:2,  image:'/signs/ontario/yield.png',             question:'ماذا تعني هذه اللافتة؟', choices:['توقف تماماً','أسرع للاندماج','أعطِ الأولوية للمرور غير المواجه لهذه اللافتة ولجميع المشاة','لا انعطاف بالاتجاه العكسي'], correct:2, explanation:'لافتة الإفساح تعني الإبطاء وإعطاء الأولوية للمرور الموجود في التقاطع وللمشاة العابرين.' },
  { id:3,  image:'/signs/ontario/do_not_enter.png',      question:'ماذا تعني هذه اللافتة؟', choices:['شارع باتجاه واحد أمامك','لا تدخل — المرور يسير في اتجاهك','الطريق مغلق بشكل دائم','منطقة بناء أمامك'], correct:1, explanation:'لافتة "لا تدخل" تعني أن المرور يسير نحوك في ذلك المسار. لا تدخل من اتجاهك.' },
  { id:4,  image:'/signs/ontario/wrong_way.png',         question:'ماذا تعني هذه اللافتة؟', choices:['طريق تحت الإنشاء','أنت تسير في الاتجاه الخاطئ — لا تتابع','شارع باتجاه واحد أمامك','تحويل مسار أمامك'], correct:1, explanation:'لافتة "الاتجاه الخاطئ" تظهر على مخارج الطرق السريعة وشوارع الاتجاه الواحد لتحذيرك من السير في الاتجاه الخاطئ.' },
  { id:5,  image:'/signs/ontario/speed_limit_50.png',    question:'ماذا تعني هذه اللافتة؟', choices:['الحد الأدنى للسرعة 50 كم/س','السرعة الموصى بها للمنعطف','تنتهي منطقة الحد الأقصى للسرعة','الحد الأقصى للسرعة 50 كم/س'], correct:3, explanation:'لافتات الحد الأقصى للسرعة تُظهر أقصى سرعة مسموح بها في ظروف الطريق والطقس المثالية. 50 كم/س هو الحد الافتراضي في المناطق الحضرية في ألبرتا.' },
  { id:6,  image:'/signs/ontario/speed_limit_100.png',   question:'ماذا تعني هذه اللافتة؟', choices:['الحد الأدنى للسرعة 100 كم/س','الحد الأقصى للسرعة 100 كم/س — الحد الافتراضي على الطرق الإقليمية في ألبرتا خارج المناطق الحضرية','السرعة الموصى بها على الطريق السريع','تنتهي منطقة الحد الأقصى للسرعة'], correct:1, explanation:'100 كم/س هو الحد الأقصى للسرعة على الطرق الإقليمية خارج المناطق الحضرية في ألبرتا ما لم تُنشر لافتة أخرى.' },
  { id:7,  image:'/signs/ontario/speed_limit_80.png',    question:'ماذا تعني هذه اللافتة؟', choices:['السرعة الموصى بها للمنعطف','الحد الأقصى للسرعة 80 كم/س','الحد الأدنى للسرعة 80 كم/س','تنتهي منطقة الحد الأقصى'], correct:1, explanation:'80 كم/س هو الحد الأقصى للسرعة على الطريق الإقليمي الواقع داخل حدود المدينة، أو على الطريق خارج المنطقة الحضرية غير الإقليمي.' },
  { id:8,  image:'/signs/ontario/railway_crossing.png',  question:'ماذا تعني هذه اللافتة؟', choices:['مطب أمامك','تقاطع سكة حديد — انتبه للقطارات','جسر أمامك','منطقة بناء'], correct:1, explanation:'لافتة تقاطع سكة الحديد الدائرية تحذر من وجود قضبان قطار عبر الطريق. انظر في كلا الاتجاهين قبل العبور.' },
  { id:9,  image:'/signs/ontario/school_zone.png',       question:'ماذا تعني هذه اللافتة؟', choices:['منطقة مستشفى','منطقة ملاعب','منطقة مدرسية — انتبه للأطفال','ممر مشاة أمامك'], correct:2, explanation:'لافتة المنطقة المدرسية تحذر من وجود أطفال قد يكونون بالقرب. الحد الأقصى للسرعة 30 كم/س في أيام الدراسة خلال الأوقات المنشورة.' },
  { id:10, image:'/signs/ontario/pedestrian_crossing.png', question:'ماذا تعني هذه اللافتة؟', choices:['تقاطع دراجات هوائية أمامك','معبر مدرسي','ممر مشاة — انتبه للأشخاص العابرين','منطقة ملاعب'], correct:2, explanation:'لافتة ممر المشاة تحذر من وجود أشخاص قد يعبرون الطريق. أعطِ الأولوية لجميع المشاة.' },
  { id:11, image:'/signs/ontario/no_left_turn.png',      question:'ماذا تعني هذه اللافتة؟', choices:['لا انعطاف يميناً','لا انعطاف بالاتجاه العكسي','لا انعطاف يساراً في هذا التقاطع','شارع باتجاه واحد'], correct:2, explanation:'لافتة "لا انعطاف يساراً" تعني حظر الانعطاف يساراً في هذا التقاطع.' },
  { id:12, image:'/signs/ontario/no_right_turn.png',     question:'ماذا تعني هذه اللافتة؟', choices:['تابع يميناً فقط','لا انعطاف يميناً في هذا التقاطع','الطريق مغلق إلى اليمين','شارع باتجاه واحد'], correct:1, explanation:'لافتة "لا انعطاف يميناً" تعني أنه لا يمكنك الانعطاف يميناً في هذا التقاطع.' },
  { id:13, image:'/signs/ontario/no_u_turn.png',         question:'ماذا تعني هذه اللافتة؟', choices:['لا انعطاف يساراً','لا انعطاف بالاتجاه العكسي في هذا الموقع','تابع مباشرة فقط','مرور باتجاه واحد'], correct:1, explanation:'لافتة "لا انعطاف بالاتجاه العكسي" تعني أنه لا يمكنك الانعطاف بالاتجاه العكسي في هذا الموقع.' },
  { id:14, image:'/signs/ontario/do_not_pass.png',       question:'ماذا تعني هذه اللافتة؟', choices:['تجاوز عند الأمان فقط','لا تجاوز على هذا الطريق','مسار التجاوز أمامك','يجب على المركبات البطيئة التجاوز هنا'], correct:1, explanation:'لافتة "لا تجاوز" تعني أنه لا يُسمح لك بتجاوز المركبات الأخرى في هذا القسم من الطريق.' },
  { id:15, image:'/signs/ontario/two_way_traffic.png',   question:'ماذا تعني هذه اللافتة؟', choices:['ينتهي المسار — اندمج يساراً','ينتهي الطريق المقسوم','مرور باتجاهين أمامك','الطريق يضيق'], correct:2, explanation:'هذه اللافتة تحذر من دخول قسم من الطريق بمرور من اتجاهين. ابقَ على اليمين.' },
  { id:16, image:'/signs/ontario/keep_right.png',        question:'ماذا تعني هذه اللافتة؟', choices:['الطريق مغلق','ابقَ على يمين الفاصل أمامك','ينتهي المسار — اندمج يميناً','منطقة لا تجاوز'], correct:1, explanation:'لافتة "ابقَ على اليمين" تعني يجب أن تمر من الجانب الأيمن لجزيرة مرورية أو فاصل.' },
  { id:17, image:'/signs/ontario/curve_ahead.png',       question:'ماذا تعني هذه اللافتة؟', choices:['انعطاف حاد إلى اليمين','ينتهي الطريق','منحنى أمامك — أبطئ وكن مستعداً','تحويل مسار يميناً'], correct:2, explanation:'لافتة المنحنى تحذر من وجود منعطف في الطريق. أبطئ قبل الدخول في المنحنى وابقَ في منتصف مسارك.' },
  { id:18, image:'/signs/ontario/sharp_turn.png',        question:'ماذا تعني هذه اللافتة؟', choices:['منحنى لطيف أمامك','طريق متعرج أمامك','منعطف حاد جداً أمامك — أبطئ بشكل كبير','ينتهي الطريق'], correct:2, explanation:'لافتة المنعطف الحاد تدل على منحنى شديد. أبطئ جيداً قبل الوصول إلى اللافتة للحفاظ على السيطرة.' },
  { id:19, image:'/signs/ontario/winding_road.png',      question:'ماذا تعني هذه اللافتة؟', choices:['منحنى واحد أمامك','منعطف حاد أمامك','الطريق به عدة منحنيات أمامك — قُد بعناية','تحويل مسار أمامك'], correct:2, explanation:'لافتة الطريق المتعرج تحذر من وجود سلسلة من المنحنيات أمامك. أبطئ وقُد بعناية.' },
  { id:20, image:'/signs/ontario/slippery_road.png',     question:'ماذا تعني هذه اللافتة؟', choices:['طريق تحت الإنشاء','طريق حصوي أمامك','الطريق قد يكون زلقاً عند البلل — أبطئ','طريق وعر أمامك'], correct:2, explanation:'لافتة الطريق الزلق تحذر من أن سطح الطريق يصبح خطيراً عند البلل أو الجليد. أبطئ وزِد مسافة المتابعة.' },
  { id:21, image:'/signs/ontario/deer_crossing.png',     question:'ماذا تعني هذه اللافتة؟', choices:['حيوانات المزرعة تعبر','الحيوانات البرية تعبر هنا بكثرة — انتبه','منطقة غابات أمامك','منطقة صيد'], correct:1, explanation:'لافتة عبور الحيوانات البرية تحذر من تواجد الغزلان وغيرها من الحيوانات في هذه المنطقة. أبطئ وكن يقظاً.' },
  { id:22, image:'/signs/ontario/construction.png',      question:'ماذا تعني هذه اللافتة؟', choices:['مستشفى أمامك','عمال ومعدات على الطريق أو بالقرب منه — أبطئ','الطريق مغلق بشكل دائم','يبدأ التحويل'], correct:1, explanation:'لافتات البناء تحذر من وجود أعمال طريق أمامك. تُضاعَف الغرامات في مناطق البناء عند وجود عمال.' },
  { id:23, image:'/signs/ontario/road_narrows.png',      question:'ماذا تعني هذه اللافتة؟', choices:['جسر أمامك','يبدأ إنشاء الطريق','الطريق يضيق أمامك — ابقَ في الوسط','ينتهي المسار — اندمج يساراً'], correct:2, explanation:'لافتة تضييق الطريق تحذر من تقلص عرض الرصيف أمامك. أبطئ وكن يقظاً.' },
  { id:24, image:'/signs/ontario/divided_highway.png',   question:'ماذا تعني هذه اللافتة؟', choices:['يبدأ مرور باتجاهين','ينتهي الطريق المقسوم — مرور باتجاهين أمامك','مدخل الطريق السريع','تنتهي الجزيرة الوسطى'], correct:1, explanation:'هذه اللافتة تحذر من نهاية الطريق المقسوم ودخول طريق بمرور من اتجاهين. ابقَ على اليمين.' },
  { id:25, image:'/signs/ontario/hill_ahead.png',        question:'ماذا تعني هذه اللافتة؟', choices:['مطب أمامك','منحدر حاد أمامك — تحقق من الفرامل وتحكم في السرعة','ينتهي الطريق عند الماء','طريق وعر أمامك'], correct:1, explanation:'لافتة المنحدر الحاد تحذر من انحدار شديد. أبطئ واستخدم تروساً منخفضة لمنع ارتفاع حرارة الفرامل.' },
  { id:26, image:'/signs/ontario/merge_right.png',       question:'ماذا تعني هذه اللافتة؟', choices:['ابقَ يساراً','الطريق يضيق — اندمج مع المرور على اليمين','المسار مغلق أمامك','ينتهي مسار التجاوز'], correct:1, explanation:'لافتة الاندماج تعني أن مسارك ينتهي ويجب عليك الاندماج بأمان مع المرور في الاتجاه المشار إليه.' },
  { id:27, image:'/signs/ontario/right_lane_ends.png',   question:'ماذا تعني هذه اللافتة؟', choices:['ابقَ يميناً','المسار الأيمن ينتهي أمامك — اندمج يساراً بأمان','الطريق يضيق يميناً','مخرج الطريق السريع أمامك'], correct:1, explanation:'هذه اللافتة تحذر من نهاية المسار الأيمن. يجب على سائقي المسار الأيمن الاندماج يساراً بأمان.' },
  { id:28, image:'/signs/ontario/bicycle_crossing.png',  question:'ماذا تعني هذه اللافتة؟', choices:['يبدأ مسار الدراجات','يجب على الدراجين التوقف هنا','الدراجات تعبر الطريق أمامك — انتبه للدراجين','ينتهي مسار الدراجات'], correct:2, explanation:'هذه اللافتة التحذيرية تُعلم السائقين بأن الدراجين قد يعبرون الطريق أمامهم. أبطئ وكن يقظاً.' },
  { id:29, image:'/signs/ontario/stop_ahead.png',        question:'ماذا تعني هذه اللافتة؟', choices:['لافتة إفساح أمامك','إشارات ضوئية أمامك','أبطئ — لافتة STOP أمامك','الطريق مغلق أمامك'], correct:2, explanation:'هذه اللافتة التحذيرية تُعلمك بأن لافتة STOP قادمة. ابدأ بتقليل سرعتك الآن وكن مستعداً للتوقف التام.' },
  { id:30, image:'/signs/ontario/no_parking.png',        question:'ماذا تعني هذه اللافتة؟', choices:['لا وقوف في أي وقت','الوقوف محظور في هذه المنطقة','منطقة لا وقوف','منطقة قطر المركبات'], correct:1, explanation:'لافتة "لا وقوف" تعني أنه لا يمكنك إيقاف مركبتك في هذا الموقع خلال الأوقات المشار إليها.' },
];
...
const ALL_QUESTIONS = {
  ...
  'alberta-class5-signs': ALBERTA_SIGNS_QUESTIONS.slice(0, 5),
  'alberta-class5-arabic':       ALBERTA_ARABIC_QUESTIONS.slice(0, 5),
  'alberta-class5-signs-arabic': ALBERTA_ARABIC_SIGNS_QUESTIONS.slice(0, 5),
...
const TEST_NAMES = {
  ...
  'alberta-class5':       'Alberta Class 7 — General Rules',
   'alberta-class5-signs': 'Alberta Class 7 — Road Signs',
   'alberta-class5-arabic':       'اختبار الصنف 7 في ألبرتا — القواعد العامة',
   'alberta-class5-signs-arabic': 'اختبار الصنف 7 في ألبرتا — إشارات الطريق',
...
const HEADER_COLORS = {
  ...
  'alberta-class5-signs': '#92400E',
  'alberta-class5-arabic':       '#92400E',
  'alberta-class5-signs-arabic': '#92400E',
  'citizenship':      '#DC2626',
  'food-handler':     '#D97706',
  'whmis':            '#DC2626',
...
const isSigns = testSlug === 'ontario-g1-signs' || testSlug === 'bc-knowledge-signs' || testSlug === 'ontario-g1-signs-arabic' || testSlug === 'alberta-class5-signs' || testSlug === 'alberta-class5-signs-arabic';  const isArabic = testSlug?.includes('arabic');
...
if (params.testSlug === 'alberta-class5-arabic' || params.testSlug === 'alberta-class5-signs-arabic') {
  return purchases.includes('alberta-class5');
}
  ...
  const allFull = {
    ...
    'alberta-class5-signs': ALBERTA_SIGNS_QUESTIONS,
    'alberta-class5-arabic':       ALBERTA_ARABIC_QUESTIONS,
    'alberta-class5-signs-arabic': ALBERTA_ARABIC_SIGNS_QUESTIONS,
